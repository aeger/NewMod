...
namespace NewMod
{
    ...
    public class NewModPlugin : BaseUnityPlugin
    {
        internal const string ModName = "NewMod";
        internal const string ModVersion = "1.0.0";
        internal const string Author = "almty1";
        ...
        public static readonly ManualLogSource NewModLogger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                NewModLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                NewModLogger.LogError($"There was an issue loading your {ConfigFileName}");
                NewModLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
